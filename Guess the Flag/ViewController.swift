...
class ViewController: UIViewController {
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        let endGameAlertController = UIAlertController(title: "Game Over!", message: "Your score is \(score)", preferredStyle: .alert)
        endGameAlertController.addAction(UIAlertAction(title: "Start new game", style: .default, handler: askQuestion))
